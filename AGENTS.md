...
- Flutter changes:
  ...
  - After code changes that affect the iOS/Android app, reinstall the latest Flutter app build on the active simulator/emulator before handing back to the user.
