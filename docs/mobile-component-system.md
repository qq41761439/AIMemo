...
- 阴影：轻柔下投影，避免重阴影和深色容器。
- 字号：页面标题 22，区块/按钮 16，标签 14，辅助信息 12；顶部 Tab 和任务分区标题使用 16 semibold，只有品牌 hero 与关键数字允许小幅放大。
...
- Tasks：顶部 Tasks/Summary 切换、标签筛选、Active/Upcoming/Completed 分组、任务行、底部快速添加栏。
